...
public class TestabilityTests
{
    ...
    {
        // Arrange
        var types = Types.InAssembly(typeof(Infrastructure.Context.UsersDbContext).Assembly)
            .That()
    ...
    public void Static_Classes_Should_Be_Limited()
    {
        ...
        // Act
        var staticClasses = Types.InAssembly(typeof(Application.Services.UserService).Assembly)
            .That()
            .AreClasses()
            .And()
            .AreStatic()
